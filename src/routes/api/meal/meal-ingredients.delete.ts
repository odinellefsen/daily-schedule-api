...
meal.delete("/ingredients", async (c) => {
    ...
    const mealIngredientsArchivedEvent = mealIngredientsArchiveSchema.safeParse(
        mealIngredientsArchived
    );
    ...
    const safeMealIngredientsArchivedEvent = mealIngredientsArchivedEvent.data;

    try {
        await FlowcorePathways.write("meal.v0/meal-ingredients.archived.v0", {
