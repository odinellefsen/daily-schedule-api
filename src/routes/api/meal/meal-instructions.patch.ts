...
meal.patch("/instructions", async (c) => {
    ...
    const safeUpdateMealInstructionsRequestBody = parsedRequestJsonBody.data;
    ...
    const existingInstructions = await db
        ...
        .from(mealSteps)
        .where(
            eq(mealSteps.mealId, safeUpdateMealInstructionsRequestBody.mealId)
        );
    ...
    const updateMealInstructionsEvent = mealInstructionsUpdateSchema.safeParse(
    ...
    const safeUpdateMealInstructionsEvent = updateMealInstructionsEvent.data;
