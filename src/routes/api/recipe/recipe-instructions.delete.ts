...
export function registerDeleteRecipeInstructions(app: Hono) {
    app.delete("/instructions", async (c) => {
        ...
        const safeDeleteRecipeInstructionsRequestBody =
        ...
        const recipeInstructionsArchivedEvent =
            recipeInstructionsArchiveSchema.safeParse(
                recipeInstructionsArchived,
            );
        ...
        try {
            ...
            return c.json(
                ApiResponse.error(
                    "Failed to archive recipe instructions",
                    error,
                ),
